...
export class FlipMenu {
  constructor(containerSelector, options = {}) {
    ...
    this.options = Object.assign({
      ...
      roomImagesPage: 21,
      roomImages: [
        'standalone-celestial-menu%20(2)/public/images/services/thai.png',
        'standalone-celestial-menu%20(2)/public/images/services/hotstone.png',
        'standalone-celestial-menu%20(2)/public/images/services/aroma-oil.png'
      ],
      toolsImagesPage: 22,
      toolsImages: [
        'standalone-celestial-menu%20(2)/public/images/services/facial.png',
  ...
  initCore() {
    const MENU_CONFIG = this.options;
    const PAGE_BG_IMAGES = this.options.pageBgImages;
    // Closure scope begins for legacy code
    ...
    const categories = [
      ...
      },
      {
        ...
        satellites: [
          { id: "music", icon: { src: "standalone-celestial-menu%20(2)/public/assets/icons/add-more.webp", alt: "Music", mode: "gold-mask", scale: 0.78 }, angle: 2, distance: 1.15, size: 0.2, orbitSpeed: 0.18 },
          { id: "steam", icon: { src: "standalone-celestial-menu%20(2)/public/images/services/aroma-oil.png", alt: "Steam", mode: "gold-mask", scale: 0.72 }, angle: 310, distance: 1.08, size: 0.2, orbitSpeed: 0.14 },
        ],
        services: [
          { id: "galaxy-package", name: "Gói Galaxy 120'", description: "Kết hợp body, gội đầu và chăm sóc cổ vai gáy trong một nhịp thư giãn dài.", duration: 120, price: 980000, image: { src: "standalone-celestial-menu%20(2)/public/images/additional-premium.png", alt: "Relaxation package", mode: "original", fit: "cover" }, badge: "Premium" },
        ],
      },
    ];
    ...
    function createPageTexture(pageIndex) {
      ...
      if (isCover) {
        ...
        if (pageIndex === 2) {
          ...
          ctx.fillText('[ Hình ảnh đồ nghề ]', canvas.width / 2, 600);
          ctx.font = '24px Inter, sans-serif';
          ctx.fillStyle = '#888';
          ctx.fillText('Placeholder for tools image', canvas.width / 2, 650);
        }
      }
    ...
    scene.background = null; // Transparent — inherits parent background
    scene.fog = null; // Disabled — fog tints the transparent background
    ...
    function transitionPanel(nextStage, updateState) {
      ...
      if (sheet) sheet.classList.add("switching");
      ...
      state.panelTimer = window.setTimeout(
        () => {
          ...
          requestAnimationFrame(() => {
            const sh = document.getElementById("serviceSheet");
            if (sh) sh.classList.remove("switching");
          });
        },
    ...
    function renderServices() {
      ...
      if (sheetKicker) sheetKicker.textContent = "Danh mục";
      
      const sheetTitle = document.getElementById("sheetTitle");
      if (sheetTitle) sheetTitle.textContent = category.name;
    ...
    function animate() {
      ...
      const showConstellation = false; // TẮT HIỆU ỨNG CŨ
    ...
    async function init() {
      ...
      buildUI();
      const hud2 = document.querySelector('#flip-app .hud');
    ...
    if (mPrev) mPrev.addEventListener("click", () => shiftMobileCategory(-1));
    const mNext = document.getElementById("mobileNext");
    if (mNext) mNext.addEventListener("click", () => shiftMobileCategory(1));
