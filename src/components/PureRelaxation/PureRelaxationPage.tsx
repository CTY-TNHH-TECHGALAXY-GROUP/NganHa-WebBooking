              ...
              {Boolean((finalSectionContent as any).image1 || section.id === 'foot-care') && (
                <div className={styles.perspectivePhotoFrame}>
                  <img 
                    ...
                    loading="lazy"
                  />
                  {(finalSectionContent as any).image1Caption && (
                    <div className={styles.perspectivePhotoCaption}>{(finalSectionContent as any).image1Caption}</div>
                  )}
                </div>
              )}
              ...
              {Boolean((finalSectionContent as any).image2 || section.id === 'foot-care') && (
                <div className={styles.perspectivePhotoFrame}>
                  <img 
                    ...
                    loading="lazy"
                  />
                  {(finalSectionContent as any).image2Caption && (
                    <div className={styles.perspectivePhotoCaption}>{(finalSectionContent as any).image2Caption}</div>
                  )}
                </div>
              )}
